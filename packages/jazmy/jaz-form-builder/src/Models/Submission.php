...
class Submission extends Model
{
    ...
    {
        return $this->belongsTo(\Modules\GlobalSetting\Entities\GlobalSetting::class)->where('key', 'lead_source');
    }

    public function department()
    {
        return $this->belongsTo(\Modules\Department\Entities\Department::class);
    }

    public function status()
    {
        return $this->belongsTo(\Modules\GlobalSetting\Entities\GlobalSetting::class)->where('key', 'lead_status');
    }

    public function type()
    {
        return $this->belongsTo(\Modules\GlobalSetting\Entities\GlobalSetting::class)->where('key', 'lead_type');
    }
