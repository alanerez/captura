...
@section('breadcrumbs')
{{ Breadcrumbs::render('lead-type.index') }}
@endsection
@section('styles')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="header">
                    ...
                    <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#add-modal">Add New Lead Type</button>
                    @endpermission
                </div>
                <div class="body">
...
@include('lead_type::includes._modal_edit')
@endpermission
@permission('add-lead-type')
@include('lead_type::includes._modal_add')
@endpermission
@endsection
@section('scripts')
...
<script>
    ...
    $(document).on('click', '[id=btn-edit]', function(){
        var id = $(this).data('id');
        var show_route = '{{ route('lead-type.show', ':id') }}';
        var update_route = '{{ route('lead-type.update', ':id') }}';
